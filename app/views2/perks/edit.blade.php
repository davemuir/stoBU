                  ...
                  <div class="item">
                      ...
                      {{ Form::text("beamtitle", $beamID['title'], [
                        "placeholder" => $beamID['title'] ,"class" =>"form-control","id"=>"beamTitle"
                            ...
                            {{ Form::label("beamtitle", "Perk Label") }}
                ...
                <div class="col-md-12">
                  ...
                  ?>
						<div class="item">
							...
							{{ Form::text("beamtag", $tags, [ "placeholder" => "tags ","class" =>"form-control" ]) }}

							{{ Form::label("beamdisclaimer", "disclaimer(fine-print at bottom)") }}
               <?php if(isset($beamID->disclaimer)){ ?>
                      {{ Form::text("beamdisclaimer", $beamID->disclaimer, [
                          "placeholder" => "disclaimer ","class" =>"form-control", "id"=>"beamDisclaimer",
                      ]) }}
               <?php }else{ ?>
                			{{ Form::text("beamdisclaimer", "disclaimer", [
			                    "placeholder" => "disclaimer ","class" =>"form-control", "id"=>"beamDisclaimer",
			                ]) }}
							    <?php } ?> 
						</div>
