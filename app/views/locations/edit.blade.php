...
<script>
	$(document).ready(function(){
		...
		var locationid = "<?php echo $location[0]->_id;?>";
		//remove function
		...
		function submitLocation(beaconArr,locationName,address){
			...
			$.ajax({
				    type: 'post',
					url: 'http://'+rootLocation+'/index.php/locations/update/'+locationid,
        	...
        	var currentTab = $('#rootwizard').bootstrapWizard('currentIndex') ;
				switch(currentTab) {
			    	case 0:
						...
						if( addressString == ''){
								alert("campaign Name is not filled");
								return false;
						}
						if( $('#locationName').val() == ''){
				...
				<div class="tab-content">
			    	<div class="tab-pane" id="tab1">
			    		<div class="container">
			    			...
			    			<div class="row">
					    		<div class="col-sm-6" >
							      <input id="locationName" class="form-control" type="textbox" value="<?php echo $location[0]->name;?>">
			    			...
			    			<div class="row">
					    		<div class="col-sm-6">
							      <input id="address" class="form-control" style="width:100%" type="textbox" value="<?php echo $location[0]->address;?>">
							      <!--<input type="button" value="Geocode"  id="addGeocode"> -->
							    </div>
							</div>
					    </div>
				        	...
				        	<div class="row">
					     	 ...
					     	 <?php 
					     	 	foreach($beacons as $beacon){
					     	 		$bCount = 0; 
					     	 		foreach($location[0]->beacons as $beaconA){ 
						 ...
						 <div class="row">
							...
							<div class="row">
							    ...
							    <div id="reviewZone">
							    	...
							    	<button class="btn btn-primary" id="submitLocation">Update</button>
							    </div>
							 </div>
