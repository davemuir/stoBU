...
$(document).ready(function(){
    ...
    var beaconArr = [];
    var beaconAlias;
    var beaconUUID, beaconMajor, beaconMinor, beaconLocation, locationID;

    var beaconID = "<?php echo $beacon->_id; ?>";
    beaconAlias = "<?php echo $beacon->alias; ?>";
    beaconUUID = "<?php echo $beacon->uuid; ?>";
    beaconMajor = "<?php echo $beacon->major; ?>";
    beaconMinor = "<?php echo $beacon->minor; ?>";
    beaconLocation = "<?php echo $beacon->location; ?>";

    //call the location name for the locations ID

     
        var xhr = new XMLHttpRequest();
        xhr.open('GET', 'http://'+rootLocation+'/api/locationid/'+beaconLocation, false);
        xhr.send(null);
        if (xhr.status == 200) {
           console.log("successful location call");
           ...
           if(xhr.response == null || xhr.response == ''){
            ...
            $('#locationDropdown').text(resp['name']);
            $('#locationDropdown').val(resp['_id']);
            $('#reviewLocation').text(resp['name']);
          }
        }
    ...
    function submitBeacon(locationID,beaconAlias,beaconUUID,beaconMajor,beaconMinor){
            $.ajax({
              type: 'post',
              url: 'http://'+rootLocation+'/beacons/updateBeacon',
              data: {locationID:locationID,beaconAlias:beaconAlias,beaconUUID:beaconUUID,beaconMajor:beaconMajor,beaconMinor:beaconMinor,beaconID:beaconID},
              success: function(response) { 
                console.log(response);
                $('#tab3 .container').html('<div class="inner-content"><h1>Beacon Updated</h1></div>');
                setTimeout(function(){  
                  window.location.assign('http://'+rootLocation+'/beacons');
                }, 3000);
      ...
      tabClass: 'nav nav-pills',
          onTabShow: function(tab, navigation, index){
            ...
            if(index == 2){
              ...
              $('#reviewLocation').html($('#locationDropdown').text());
        ...
        <div class="tab-content">
            <div class="tab-pane" id="tab1">
              <div class="container">
                ...
                <div class="row">
                  <div class="col-sm-6" >
                    <input id="beaconName" class="form-control" type="textbox" value="<?php echo $beacon->alias; ?>" placeholder="Beacon Alias">
                  ...
                  <div class='col-sm-6'>
                    <div class="btn-group" id="beaconManufacturerBtnGroup">
                      ...
                      <ul class="dropdown-menu" id="beaconManufacturerDropdownMenu">
                          <li value="E2C56DB5DFFB48D2B060D0F5A71096E0"><img src="/img/april_beacon.png">April Brothers - <span>E2C56DB5DFFB48D2B060D0F5A71096E0</span></li>
                          <li value="24DDF4118CF1440C87CDE368DAF9C93E"><img src="/img/reco.png">Reco Beacon - <span>24DDF4118CF1440C87CDE368DAF9C93E</span></li>
                      </ul>
                    </div>
                  </div>
              </div>
              ...
              <div class="row">
                  <div class="col-sm-6">
                    <input id="beaconUUID" class="form-control" style="width:100%" value="<?php echo $beacon->uuid; ?>" type="textbox" placeholder="Beacon UUID">
                    <!--<input type="button" value="Geocode"  id="addGeocode"> -->
                  </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                  <div class="col-sm-6" >
                    <input id="beaconMajor" class="form-control" type="textbox" value="<?php echo $beacon->major; ?>" placeholder="Beacon Minor (eg. 1)">
                    <!--<input type="button" value="Geocode"  id="addGeocode"> -->
                  </div>
              </div>
                 <div class="row">
              ...
              <div class="row">
                  <div class="col-sm-6" >
                    <input id="beaconMinor" class="form-control" type="textbox" value="<?php echo $beacon->minor; ?>" placeholder="Beacon Minor (eg. 22)">
                    <!--<input type="button" value="Geocode"  id="addGeocode"> -->
                  </div>
              </div>
            ...
            <div class="tab-pane" id="tab2">
                <div class="container">
                  ...
                  <div class='col-sm-6'>
                    <div class="btn-group" id="beaconManufacturerBtnGroup">
                      <button class="btn btn-default btn-sm dropdown-toggle" value="<?php echo $beacon->locationID; ?>" id="locationDropdown" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="tab-pane" id="tab3">
             ...
             <div class="row">
              ...
              <div class="row">
                 ...
                 <div class="row">
                    <button class="btn btn-primary" id="submitBeacon">Update Beacon</button>
                  </div>
              </div>
            </div>
        </div>  
