          ...
          <div class="whitePanel">
              <div id="iphonePreview">
                ...
                <div class="sendBeamButtonContainer">
                      <a href="{{URL::route('CMS')}}"><div id="cancelBeam" class="optionButton btn btn-primary">Cancel</div></a>
                      {{ Form::submit("Save" , array('class' => 'sendBeam btn btn-primary', "id" => "sendBeam", "onclick" => "validateBeam()")) }}
                </div>
            </div>
          </div>
